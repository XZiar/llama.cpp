...
#if defined(HAVE_AVX512_BW)
    inline static const __m512i min_value512 = _mm512_set1_epi8(minv);
    inline static const __m512i shuffle_64lo16 = _mm512_set_epi16(28,28,24,24,20,20,16,16, 12,12,8,8,4,4,0,0, 28,24,20,16,12,8,4,0, 28,24,20,16,12,8,4,0);
#endif
};
