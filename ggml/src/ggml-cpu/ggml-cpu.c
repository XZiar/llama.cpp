...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_IQ4_KSS] = {
        ...
        .vec_dot                  = NULL, //ggml_vec_dot_iq4_kss_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_IQ2_KS] = {
    ...
    [GGML_TYPE_IQ3_KS] = {
        ...
        .vec_dot                  = NULL, //ggml_vec_dot_iq3_ks_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_IQ4_KS] = {
    ...
    [GGML_TYPE_IQ1_KT] = {
        ...
        .vec_dot                  = NULL, //ggml_vec_dot_iq1_kt_q8_k,
#if defined __AVX2__
    ...
    [GGML_TYPE_IQ2_KT] = {
        ...
        .vec_dot                  = NULL, //ggml_vec_dot_iq2_kt_q8_k,
#if defined __AVX2__
        .vec_dot_type             = GGML_TYPE_Q8_2_X4,
#else
        .vec_dot_type             = GGML_TYPE_Q8_0_X4,
    ...
    [GGML_TYPE_IQ3_KT] = {
        ...
        .vec_dot                  = NULL, //ggml_vec_dot_iq3_kt_q8_k,
#if defined __AVX2__
        .vec_dot_type             = GGML_TYPE_Q8_2_X4,
#else
        .vec_dot_type             = GGML_TYPE_Q8_0_X4,
    ...
    [GGML_TYPE_IQ4_KT] = {
        ...
        .vec_dot                  = NULL, //ggml_vec_dot_iq4_kt_q8_k,
#if defined __AVX2__
        .vec_dot_type             = GGML_TYPE_Q8_2_X4,
#else
        .vec_dot_type             = GGML_TYPE_Q8_0_X4,
