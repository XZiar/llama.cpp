...
static void llama_tensor_dequantize_impl(
    ...
    if (nthread < 2 || (ggml_is_quantized(type) && qtype->row_meta_size > 0)) {
                ...
                for (int64_t i03 = 0; i03 < tensor->ne[2]; ++i03) {
                    ...
                    for (int64_t ir = 0; ir < nrows; ir += nrows_slab) {
                        ...
                        if (tensor->type == GGML_TYPE_F32) {
                            ...
                            llama_tensor_dequantize_impl(tensor->type, src, (float *) f32_conv_buf.data(), workers, n_per_row, nrows_cur, nthread);
